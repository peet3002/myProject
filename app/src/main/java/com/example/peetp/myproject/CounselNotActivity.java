...
public class CounselNotActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_counsel_not);
        ...
        mToolbar = (Toolbar) findViewById(R.id.counsel_not_toolbar);
        setSupportActionBar(mToolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("บันทึกการให้คำปรึกษา");

        counselList = (RecyclerView) findViewById(R.id.counsel_not_list);
    ...
    private void DisplsyUsersCounsel() {
        Query sortPost = counselRef.child(current_user_fullname).orderByChild("receiver_status").startAt("false_" + "00000000000000").endAt("false_"+"99999999999999"+"\uf8ff");
        adapter(sortPost);
    }
                    ...
                    protected void onBindViewHolder(@NonNull final CounselViewHolder holder, int position, @NonNull Counsels model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent detailIntent = new Intent(CounselNotActivity.this, CounselDetailActivity.class);
